...
var transcriptionResultDiv = document.getElementById("transcriptionResult");
var audioFileInput = document.getElementById("audioData");
...
//     try {
//         await queryTranscription(audioFileInput.files[0]);
//     } catch (error) {
//         console.error("Error:", error);
//         transcriptionResultDiv.textContent = "Error occurred during transcription: " + error.message;
//     }
// });

// Function to send audio data for transcription
// Function to send audio data for transcription
async function queryTranscription(audioBlob) {
